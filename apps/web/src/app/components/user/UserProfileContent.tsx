    ...
    <div className="w-full">
      <Tab.Group>
        <Tab.List className="w-full flex flex-row">
          <Tab className="focus:outline-none py-2 w-1/2 flex flex-row items-center justify-center gap-1 text-gray border-b-2 border-b-gray ui-selected:text-primary ui-selected:border-b-primary">
